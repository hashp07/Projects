...
function AddProduct() {
    ...
    const addProduct = async (data) => {
        setloder(true)
        const { title, price, description, image3d, category } = data
    ...
    return (
        <div className='w-full p-6'>
            <h1 className='font-semibold text-3xl my-2'>Add Dish</h1>
            <form onSubmit={handleSubmit(addProduct)}>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-3 mt-8'>
                    <div className='w-full shadow-md border bg-white rounded-md px-3 md:px-6 py-6 lg:col-span-2'>
                        ...
                        <div className='my-1 '>
                            <label className='text-sm font-semibold px-1 text-gray-800' htmlFor="productPrice">3D Image <sup className='text-red-400'>*</sup></label>
                            <input
                                className='outline-none border focus:border-blue-700 px-3 py-2 my-2 rounded-md text-sm md:px-5 text-gray-600 font-normal w-full'
                                type="file"
                                placeholder="image3d"
                                ...
                                id="productPrice"
                                {...register("image3d", {
                                    required: '3D Image is required',
                                })}
                            />
                            {errors.image3d && <p className="text-red-500 text-xs mt-1">{errors.image3d.message}</p>}
                        </div>
