...
function Products() {
  ...
  return (
    <div className='w-full p-6'>
      <div className={popup ? `w-screen h-screen fixed left-0 z-50 top-0 flex justify-center items-center` : `hidden`}>
        <div className="bg-blue-100 rounded text-teal-900 border border-red-500 px-4 py-3 shadow-md w-80">
          <div>
            ...
            <p className="text-lg font-medium text-center">If you delete this product, it will be permanently removed.</p>
      ...
      <h1 className='font-semibold text-3xl my-2'>Menu</h1>
                ...
                <tr className="border-b-2" key={index}>
                  ...
                  <td>
                    <div className="flex items-center my-3 justify-center">
                      ...
                      <button className="text-red-500 ml-2" onClick={() => { setPopup(true); setDeleteProductId(item._id); }}>
